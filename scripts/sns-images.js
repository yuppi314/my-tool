  ...
  return `<!doctype html><html lang="ja"><head><meta charset="utf-8"><style>
    * { box-sizing: border-box; margin: 0; }
    body {
      ...
      background: #FFF8EE;
      color: #1B2A41; padding: 88px; display: flex; flex-direction: column;
    }
    .frame { position: absolute; inset: 36px; border: 3px solid #FFD2BF; border-radius: 28px; }
    .compass { position: absolute; right: -120px; bottom: -120px; width: 620px; height: 620px; opacity: 0.07; }
    main { flex: 1; display: flex; flex-direction: column; justify-content: center; position: relative; }
    .kicker { align-self: flex-start; background: #1E5AA8; color: #fff; font-size: 34px; font-weight: 700; padding: 8px 24px; border-radius: 999px; }
    h1 { font-size: ${isCover ? 104 : 76}px; line-height: 1.3; margin-top: 28px; color: #FF6B3D; white-space: pre-line; }
    .body { margin-top: 64px; display: flex; flex-direction: column; gap: 32px; }
    .body p { font-size: ${isCover ? 46 : 44}px; line-height: 1.55; border-left: 8px solid #FF6B3D; padding-left: 28px; white-space: pre-line; }
    footer { display: flex; justify-content: space-between; font-size: 32px; color: #6B7A90; position: relative; }
  </style></head><body>
    <div class="frame"></div>
    <svg class="compass" viewBox="-100 -100 200 200" fill="#1E5AA8">
